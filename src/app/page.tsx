  ...
  return (
    <main className="overflow-y-auto px-10 scrollbar-thin lg:px-20">
      ...
      >
        ...
        />
        <div className="flex max-w-max cursor-default flex-col justify-center gap-y-3 lg:gap-y-6">
          ...
          <p className="w-11/12 animate-pulse text-wrap text-justify text-lg text-slate-950">
            {` Let's build
